...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookLike.picture'
        db.add_column(u'django_facebook_facebooklike', 'picture',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookLike.picture'
        db.delete_column(u'django_facebook_facebooklike', 'picture')
