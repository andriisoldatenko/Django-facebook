...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookLike.search_index'
        db.add_column(u'django_facebook_facebooklike', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookLike.search_index'
        db.delete_column(u'django_facebook_facebooklike', 'search_index')
