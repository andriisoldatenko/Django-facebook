...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookLike.fan_count'
        db.add_column(u'django_facebook_facebooklike', 'fan_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookLike.fan_count'
        db.delete_column(u'django_facebook_facebooklike', 'fan_count')
    ...
    models = {
        ...
        u'django_facebook.facebooklike': {
            ...
            'fan_count': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
